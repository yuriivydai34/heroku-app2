...
const BackupComponent = () => {
  ...
  const handleRefreshUrl = async (id: number) => {
    try {
      await refreshCloudUrl(id);
      setSuccessMessage(t('urlRefreshed'));
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <div className="mt-2 space-y-1 text-sm text-gray-500">
                      ...
                      <p className="text-green-600">{t('autoUploaded')}</p>
                    </div>
                  </div>
                  <div className="flex flex-col gap-2 ml-4">
                    ...
                    {backup.cloudUrl && (
                      <button
                        onClick={() => handleRefreshUrl(backup.id)}
                        disabled={loading}
