  ...
  return (
    <div>
      ...
      {loading && tasks.length === 0 ? (
        ...
        >
          <TableHeader>
            <TableColumn onClick={() => handleSort('title')}>{t('title')}</TableColumn>
            <TableColumn onClick={() => handleSort('active')}>{t('status')}</TableColumn>
            <TableColumn onClick={() => handleSort('deadline')}>{t('deadline')}</TableColumn>
            <TableColumn onClick={() => handleSort('userIdCreator')}>{t('creator')}</TableColumn>
            <TableColumn onClick={() => handleSort('userIdSupervisor')}>{t('supervisor')}</TableColumn>
